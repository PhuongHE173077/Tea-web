            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Quản lý cấu hình phí vận chuyển và ngưỡng miễn phí ship
                    </p>
                </div>
                <Button 
                    onClick={() => navigate('/admin/ship/create')}
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-green-600">
                            {shipConfigs.filter(config => config.isActive).length}
                        </div>
                        <p className="text-xs text-muted-foreground">
                            Cấu hình đang được sử dụng
                        </p>
                    </CardContent>
                </Card>
                <Card>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <Select value={`${sortBy}-${sortOrder}`} onValueChange={(value) => {
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="freeShippingThreshold-desc">Ngưỡng miễn phí (Cao → Thấp)</SelectItem>
                                <SelectItem value="freeShippingThreshold-asc">Ngưỡng miễn phí (Thấp → Cao)</SelectItem>
                                <SelectItem value="shippingFee-desc">Phí ship (Cao → Thấp)</SelectItem>
                                <SelectItem value="shippingFee-asc">Phí ship (Thấp → Cao)</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </CardContent>
